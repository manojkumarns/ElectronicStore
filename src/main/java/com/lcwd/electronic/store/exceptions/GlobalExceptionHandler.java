...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponseMessage>  resourceNotFoundExcetionHandler(ResourceNotFoundException ex){
    ...
    public ResponseEntity<Map<String, Object>> handleMethodArgumenNotValidException(MethodArgumentNotValidException ex){
